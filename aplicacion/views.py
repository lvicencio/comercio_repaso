...
@permission_required('comercio.add_producto')
...
@permission_required('comercio.view_producto')
...
@permission_required('comercio.change_producto')
...
@permission_required('comercio.delete_producto')
